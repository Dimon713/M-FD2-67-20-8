export class ManViewWebPageCanvas {
    ...
    start(model, field) {
        this.myModel = model;
        this.createBtnsCanvas(this.Id, this.city)
    }

    update() {
        this.moveHands(this.Id, this.myModel.hours + this.Timezone, this.myModel.minutes, this.myModel.seconds);
    }
    ...
    moveHands(Id, hours, minutes, seconds) {
